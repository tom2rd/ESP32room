...
void setup() {
  ...
  calibrationValue_1 = 2026.23; // uncomment this if you want to set this value in the sketch
  calibrationValue_2 = 231.34; // uncomment this if you want to set this value in the sketch
